...
Add an additional one at layer 15.
"""
...
class GPT(nn.Module):
    ...
    def forward(self, input_seq: Tensor, target_seq: Tensor, sliding_window_num_blocks: Tensor):
        ...
        ve = [ve[0], ve[1], ve[2]] + [None] * (len(self.blocks) - 7) + [ve[0], ve[1], ve[2], ve[3]]
...
if master_process:
    ...
    os.makedirs("logs/14-new-valemb-15", exist_ok=True)
    logfile = f"../logs/14-new-valemb-15/{run_id_full}.txt"
    print(logfile)
