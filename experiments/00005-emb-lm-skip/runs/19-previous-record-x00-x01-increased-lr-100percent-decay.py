...
if master_process:
    ...
    os.makedirs("../logs/19-previous-record-x00-x01-increased-lr-100percent-decay", exist_ok=True)
    logfile = f"../logs/19-previous-record-x00-x01-increased-lr-100percent-decay/{run_id_full}.txt"
    print(logfile)
