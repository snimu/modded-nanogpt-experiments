...
if master_process:
    ...
    os.makedirs("../logs/690-2025-09-03-record-5-valembs-x01-5680steps", exist_ok=True)
    logfile = f"../logs/690-2025-09-03-record-5-valembs-x01-5680steps/{run_id_full}.txt"
    print(logfile)
