"""From https://github.com/KellerJordan/modded-nanogpt/blob/master/records/042225_GPT2Medium_Record8/075_640429f2-e726-4e83-aa27-684626239ffc.txt"""
...
class GPT(nn.Module):
    ...
    def forward(self, input_seq: Tensor, target_seq: Tensor, sliding_window_num_blocks: Tensor):
        ...
        ve = [ve[0], ve[0], ve[0]] + [None] * (len(self.blocks) - 6) + [ve[1], ve[1], ve[1]]
...
if master_process:
    ...
    os.makedirs("../logs/11-shared-valemb-012-131415", exist_ok=True)
    logfile = f"../logs/11-shared-valemb-012-131415/{run_id_full}.txt"
    print(logfile)
