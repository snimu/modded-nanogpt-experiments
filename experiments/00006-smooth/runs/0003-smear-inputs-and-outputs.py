...
class GPT(nn.Module):
    def __init__(
        ...
        self.smear_weight_out = nn.Parameter(init_linear(torch.empty(1, 12)).bfloat16())
    ...
    def forward(
        ...
        x = smear_embeddings(x, smear_lambda, smear_weight=self.smear_weight_out)
        if self.training:
...
if master_process:
    ...
    path = "../logs/0003-smear-inputs-and-outputs"
...
smear_params: list[nn.Parameter] = [model.smear_weight_out, model.smear_weight_in_1, model.smear_weight_in_2]
# sanity check
