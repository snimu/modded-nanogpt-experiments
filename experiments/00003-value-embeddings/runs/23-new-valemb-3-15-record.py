...
class GPT(nn.Module):
    ...
    def forward(self, input_seq: Tensor, target_seq: Tensor, sliding_window_num_blocks: Tensor):
        ...
        ve = [ve[0], ve[1], ve[2], ve[3]] + [None] * (len(self.blocks) - 8) + [ve[0], ve[1], ve[2], ve[3]]
...
if master_process:
    ...
    os.makedirs("../logs/23-new-valemb-3-15-record", exist_ok=True)
    logfile = f"../logs/23-new-valemb-3-15-record/{run_id_full}.txt"
    print(logfile)
