...
class GPT(nn.Module):
    def __init__(
        ...
        self.value_embeds = nn.ModuleList([nn.Embedding(vocab_size, model_dim) for _ in range(num_embs_per_ve)])
        self.num_ve = num_ve
...
if master_process:
    ...
    path = f"../logs/00005-extra-embs-one-valemb-num_ve{num_ve}-num_embs_per_ve{num_embs_per_ve}"
