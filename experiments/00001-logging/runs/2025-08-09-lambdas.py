"""
Print not only the validation loss, but the different lambdas in the model.

Also renamed the lambdas to better reflect their function.

Starting point is this record: https://github.com/KellerJordan/modded-nanogpt/blob/master/records/042225_GPT2Medium_Record8/075_640429f2-e726-4e83-aa27-684626239ffc.txt
"""
...
for step in range(train_steps + 1):
    ...
    if last_step or (args.val_loss_every > 0 and step % args.val_loss_every == 0):
        ...
        unet_2_11 = unet_lambdas[2].item()
        unet_4_10 = unet_lambdas[4].item()
        unet_6_9 = unet_lambdas[6].item()
        ...
        print0(f"step:{step}/{train_steps} unet_lambda_2_11:{unet_2_11:.6f} unet_lambda_4_10:{unet_4_10:.6f} unet_lambda_6_9:{unet_6_9:.6f}", console=True)
