...
if master_process:
    ...
    os.makedirs("../logs/66-2025-09-03-record-5-valembs-x01-5640steps", exist_ok=True)
    logfile = f"../logs/66-2025-09-03-record-5-valembs-x01-5640steps/{run_id_full}.txt"
    print(logfile)
