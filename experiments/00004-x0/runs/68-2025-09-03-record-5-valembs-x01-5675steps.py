...
class Hyperparameters:
    ...
    # optimization
    num_iterations = 5675 # number of iterations to run
...
if master_process:
    ...
    os.makedirs("../logs/68-2025-09-03-record-5-valembs-x01-5675steps", exist_ok=True)
    logfile = f"../logs/68-2025-09-03-record-5-valembs-x01-5675steps/{run_id_full}.txt"
    print(logfile)
