...
if master_process:
    ...
    os.makedirs("../logs/3000-concat-x00-last-mlp", exist_ok=True)
    logfile = f"../logs/3000-concat-x00-last-mlp/{run_id_full}.txt"
    print(logfile)
    ...
    if master_process:
        print0(
            summary(
                model,
                input_data={
                    "input_seq": torch.randint(0, args.vocab_size, size=(128,), device="cuda"),
                    "target_seq": torch.randint(0, args.vocab_size, size=(128,), device="cuda"),
