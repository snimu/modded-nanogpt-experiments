...
if master_process:
    ...
    os.makedirs("../logs/692-2025-09-03-record-5-valembs-x01-5690steps", exist_ok=True)
    logfile = f"../logs/692-2025-09-03-record-5-valembs-x01-5690steps/{run_id_full}.txt"
    print(logfile)
