...
class Hyperparameters:
    ...
    # optimization
    num_iterations = 5660 # number of iterations to run
...
if master_process:
    ...
    os.makedirs("../logs/67-2025-09-03-record-5-valembs-x01-5660steps", exist_ok=True)
    logfile = f"../logs/67-2025-09-03-record-5-valembs-x01-5660steps/{run_id_full}.txt"
    print(logfile)
