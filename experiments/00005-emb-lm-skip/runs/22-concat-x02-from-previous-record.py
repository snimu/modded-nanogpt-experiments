...
class GPT(nn.Module):
    def __init__(self, vocab_size: int, num_layers: int, num_heads: int, model_dim: int, max_seq_len: int):
        ...
        self.embed_head = nn.Embedding(vocab_size, model_dim)
...
if master_process:
    ...
    os.makedirs("../logs/22-concat-x02-from-previous-record", exist_ok=True)
    logfile = f"../logs/22-concat-x02-from-previous-record/{run_id_full}.txt"
    print(logfile)
