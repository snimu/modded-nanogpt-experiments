...
class Hyperparameters:
    ...
    # optimization
    num_iterations = 5680 # number of iterations to run
...
if master_process:
    ...
    os.makedirs("../logs/691-2025-09-03-record-5-valembs-x01-5680steps-inverse-valemb-share", exist_ok=True)
    logfile = f"../logs/691-2025-09-03-record-5-valembs-x01-5680steps-inverse-valemb-share/{run_id_full}.txt"
    print(logfile)
