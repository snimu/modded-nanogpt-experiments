...
class GPT(nn.Module):
    def __init__(self, vocab_size: int, num_layers: int, num_heads: int, model_dim: int, max_seq_len: int):
        ...
        self.value_embeds = nn.ModuleList([nn.Embedding(vocab_size, model_dim) for _ in range(6)])
    ...
    def forward(self, input_seq: Tensor, target_seq: Tensor, sliding_window_num_blocks: Tensor):
        ...
        ve = [ve[0], ve[1], ve[2], ve[3], ve[4], ve[5]] + [None] * (len(self.blocks) - 12) + [ve[0], ve[1], ve[2], ve[3], ve[4], ve[5]]
...
if master_process:
    ...
    os.makedirs("../logs/17-new-valemb-3-13-4-14-5-15", exist_ok=True)
    logfile = f"../logs/17-new-valemb-3-13-4-14-5-15/{run_id_full}.txt"
    print(logfile)
