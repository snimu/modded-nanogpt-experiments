...
if master_process:
    ...
    path = f"../logs/0014-mtp-with-trafo-no-gate-smear_layer{smear_layer}"
...
smear_weight_params: list[nn.Parameter] = [model.smear_trafo_weight]
# sanity check
params_collections = [hidden_matrix_params, embed_params, scalar_params, head_params, smear_weight_params]
...
inner_optimizers += [inner_hidden_optim, inner_smear_weight_optim]
