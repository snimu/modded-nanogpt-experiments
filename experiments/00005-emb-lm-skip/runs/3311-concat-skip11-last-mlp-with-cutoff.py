...
class GPT(nn.Module):
    ...
    def forward(self, input_seq: Tensor, target_seq: Tensor, sliding_window_num_blocks: Tensor):
        ...
        x_cat = skip_connections[11][:, :, :self.compressed_dim]
...
if master_process:
    ...
    os.makedirs("../logs/3311-concat-skip11-last-mlp-with-cutoff", exist_ok=True)
    logfile = f"../logs/3311-concat-skip11-last-mlp-with-cutoff/{run_id_full}.txt"
    print(logfile)
