...
class GPT(nn.Module):
    ...
    def forward(self, input_seq: Tensor, target_seq: Tensor, sliding_window_num_blocks: Tensor):
        ...
        x_cat = F.relu(skip_connections[11][:, :, :self.compressed_dim])
...
if master_process:
    ...
    os.makedirs("../logs/3211-concat-skip11-last-mlp-with-cutoff-and-activation", exist_ok=True)
    logfile = f"../logs/3211-concat-skip11-last-mlp-with-cutoff-and-activation/{run_id_full}.txt"
    print(logfile)
...
# sanity check
params_collections = [hidden_matrix_params, hidden_matrix_params2, embed_params, scalar_params, head_params]
