...
if master_process:
    ...
    os.makedirs("../logs/693-2025-09-03-record-5-valembs-x01-5690steps-inverse-valemb-share", exist_ok=True)
    logfile = f"../logs/693-2025-09-03-record-5-valembs-x01-5690steps-inverse-valemb-share/{run_id_full}.txt"
    print(logfile)
