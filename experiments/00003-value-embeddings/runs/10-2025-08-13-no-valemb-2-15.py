...
class GPT(nn.Module):
    ...
    def forward(self, input_seq: Tensor, target_seq: Tensor, sliding_window_num_blocks: Tensor):
        ...
        ve = [ve[0], ve[1], None] + [None] * (len(self.blocks) - 6) + [ve[0], ve[1], None]
...
if master_process:
    ...
    os.makedirs("../logs/10-no-valemb-2-15", exist_ok=True)
    logfile = f"../logs/10-no-valemb-2-15/{run_id_full}.txt"
    print(logfile)
